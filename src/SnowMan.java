...
public class SnowMan {
	...
	private void draw() {
		...
		Rectangle hat = new Rectangle(this.x + (int) (8 * this.scale), this.y - (int) (33 * this.scale),
				(int) (15 * this.scale), (int) (30 * this.scale), Color.RED, true);
		this.window.add(hat);

		Rectangle hatBase = new Rectangle(this.x + (int) (0.9 * this.scale), this.y - (int) (4 * this.scale),
		...
		Line leftHand = new Line(this.x + (int) (scale * 7), this.y + (int) (scale * 35), this.x - (int) (scale * 25),
				this.y + (int) (scale * 35), Color.BLACK);
		this.window.add(leftHand);

		Line rightHand = new Line(this.x + (int) (scale * 10) + (int) (scale * 12), this.y + (int) (scale * 35),
				this.x + (int) (scale * 53), this.y + (int) (scale * 35), Color.BLACK);
		this.window.add(rightHand);

		Line leftFinger = new Line(this.x - (int) (scale * 20), this.y + (int) (scale * 35),
				this.x - (int) (scale * 25), this.y + (int) (scale * 30), Color.BLACK);
		this.window.add(leftFinger);

		Line rightFinger = new Line(this.x + (int) (scale * 47), this.y + (int) (scale * 35),
